    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone_home', models.CharField(blank=True, max_length=20)),
                ('telephone_mobile', models.CharField(blank=True, max_length=20)),
                ('address', models.CharField(blank=True, max_length=50)),
                ('zip_city', models.CharField(blank=True, max_length=50)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_pictures/')),
                ('role', models.CharField(choices=[('A', 'Admin'), ('P', 'Planning Manager'), ('E', 'Employee')], default='E', max_length=1)),
                ('is_verified', models.BooleanField(default=False)),
                ('start_contract', models.DateField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed_date', models.DateField(default=django.utils.timezone.now)),
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Qualifications.qualification')),
                ('changed_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_changed_by', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_created_by', to=settings.AUTH_USER_MODEL)),
